...
REM start /wait C:\LDRA_Toolsuite_C_CPP_10.1.0\conrules -delete_set=Caesar -94q
...
REM if exist C:\LDRA_Workarea_C_CPP_10.1.0\Caesar_V10_tbwrkfls rmdir /s /q C:\LDRA_Workarea_C_CPP_10.1.0\Caesar_V10_tbwrkfls\
